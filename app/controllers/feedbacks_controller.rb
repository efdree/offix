class FeedbacksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @feedback.save
        format.html { redirect_to @feedback.feedbackable, notice: "Feedback was successfully created." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to @feedback.feedbackable, notice: "Feedback was successfully destroyed." }
